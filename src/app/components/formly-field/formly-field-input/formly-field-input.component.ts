...
export class FormlyFieldInputComponent extends FieldType<FieldTypeConfig> implements OnInit, AfterViewInit {
  ...
  constructor(public sanitizer: DomSanitizer, private readonly coreService: CoreService) {
    super();
